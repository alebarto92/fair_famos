...
?>
    ...
    <div class="page-header">
        <h2>
            ...
            <?php if ($numero_records==0 && $modulo['id_modulo']==80) { ?>
            <?php  } else { ?>
                <div class="pull-right">
                    ...
                    <?php } else {
                        if (($permessi_modulo['Can_create'] == 'si') && ($modulo['abilita_bottone_new'] == 'si')) {
                            $idcantiere=$_GET['p']['id_sede'];
                            $aggiunta='';
                            if ($modulo['id_modulo']==80 && $idcantiere>0) {
                                $aggiunta="&k=id_sede-".$idcantiere;
                            }

                            ?>
                            <a
                                    href="get_element.php?debug=<?php echo $_GET['debug']; ?>&idmod=<?php echo $modulo['id_modulo']; ?>&idele=-1<?php echo $aggiunta;?>"
    ...
    if ($numero_records>0) :
        ...
        <div>
            <form>
                <table id="dynamic-table" class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                    ...
                    <?php foreach ($righe as $ev) : ?>
                        <tr id="<?php echo $ev['ordine'];?>" idmodalele="<?php echo $ev['chiaveprimaria'];?>" idmodalmod="<?php echo $modulo['id_modulo'];?>" >
                                        ...
                                        <div class="btn-group" style="text-align:center;">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <?php if ($modulo['nome_modulo']=='Cantieri') { ?>
                                                    <li class="divider"></li>
                                                    <li class="dropdown-header"><?php echo _('Servizi');?></li>
                                                <?php } ?>
                                                <?php if (($modulo['nome_modulo']=='Cantieri') and ($permessi_modulo['Can_create']=='si')) { $tmpmod=getModulo(getModuloFrom_nome_modulo('Servizi')); ?>
                                                    <?php if ($tmpmod['aprimodal']=='si') { ?>
                                                        <li><a data-toggle="tooltip" title="<?php echo _('Altro servizio');?>" class="aprimodal-ele"  k="id_sede-<?php echo $ev['chiaveprimaria'];?>" nomemodalmod="<?php echo $tmpmod['nome_modulo'];?>" idmodalmod="<?php echo $tmpmod['id_modulo'];?>" idmodalele="-1" href="#" >NUOVO </a></li>
                                                    <?php } else { ?>
                                                        <li><a href="get_element.php?idele=-1&debug=<?php echo $_GET['debug'];?>&idmod=<?php echo $tmpmod['id_modulo'];?>&k=id_sede-<?php echo $ev['chiaveprimaria'];?>" data-toggle="tooltip" title="<?php echo _('Altro servizio');?>">NUOVO </a></li>
                                                    <?php } ?>
                                                <?php } ?>
                                                <?php if (($modulo['nome_modulo']=='Cantieri')) { $tmpmod=getModulo(getModuloFrom_nome_modulo('Servizi')); ?>
                                                    <?php
                                                    $totsedi=0;
                                                    ...
                                                    ?>
                                                    <?php if ($totsedi==0) { ?>
                                                        <li class="disabled"><a data-toggle="tooltip" title="<?php echo _('Servizi');?>" >ELENCO <span class="badge"><?php echo $totsedi;?></span></a></li>
                                                    <?php } else { ?>
                                                        <li><a data-toggle="tooltip" title="<?php echo _('Servizi');?>" href="module.php?modname=Servizi&p[id_sede]=<?php echo $ev['chiaveprimaria'];?>">ELENCO <span class="badge"><?php echo $totsedi;?></span></a></li>
                                                    <?php } ?>
                                                    <?php if ($permessi_modulo['Can_update']=='si'): ?>
                                                        <li><a class="aprimodal-dettagli"  idcliente="<?php echo $ev['id_cliente'];?>" idmodalele="<?php echo $ev['chiaveprimaria'];?>" data-toggle="tooltip" title="<?php echo _('Copia Servizi');?>" >COPIA SERVIZI </a></li>
                                                    <?php endif; ?>

                                                    <li class="divider"></li>
                                                    <li class="dropdown-header"><?php echo _('Attivita');?></li>
                                                    <?php
                                                    $totsedi=0;
                                                    ...
                                                    ?>
                                                    <?php if ($totsedi==0) { ?>
                                                        <li class="disabled"><a data-toggle="tooltip" title="<?php echo _('Attivita');?>" >ELENCO <span class="badge"><?php echo $totsedi;?></span></a></li>
                                                    <?php } else { ?>
                                                        <li><a data-toggle="tooltip" title="<?php echo _('Attivita');?>" href="module.php?modname=AttivitaClean&p[id_sede]=<?php echo $ev['chiaveprimaria'];?>">ELENCO <span class="badge"><?php echo $totsedi;?></span></a></li>
                                                    <?php } ?>
                                                ...
                                                <?php //(i) AttivitaClean ?>
                                                <?php if (($modulo['nome_modulo']=='AttivitaClean') and ($permessi_modulo['Can_update']=='si')) { ?>
                                                    <li><a data-toggle="tooltip" title="<?php echo _('Controllo Pdf');?>" target="_blank" href="controlloPdfAttivita.php?codice_attivita=<?php echo $ev['chiaveprimaria'];?>"><i class="fa fa-file-pdf-o"></i> CONTROLLO PDF</a></li>
                                                    <li><a data-toggle="tooltip" title="<?php echo _('Invia Pdf al Cliente');?>" href="controlloPdfAttivita.php?codice_attivita=<?php echo $ev['chiaveprimaria'];?>"><i class="fa fa-envelope"></i> INVIA PDF AL CLIENTE</a></li>
                                                    <!--<li><a data-toggle="tooltip" title="<?php echo _('Replica');?>" class="replicaattivita" idmodalmod="<?php echo $modulo['id_modulo'];?>" idmodalele="<?php echo $ev['chiaveprimaria'];?>" href="#"><i class="fa fa-calendar"></i> REPLICA</a></li>-->
                                                <?php } ?>

                                                <?php //(f) AttivitaClean ?>

                                                <?php //(i) Timbrature ?>
                                                <?php if (($modulo['nome_modulo']=='Timbrature') and ($permessi_modulo['Can_update']=='si')) { ?>
                                                    <li><a data-idattivita="<?php echo $ev['id_attivita'];?>" class="aprimappaosm"> vedi su MAPPA </li>
                            ...
                            <?php foreach ($header as $h) :
                                ...
                                if (($columns1[$h]['tipo'])=="DATE") {
                                    $datasort="data-sort= '".$ev[$h]."'";
                                    $ev[$h]=convertDate($ev[$h]);
                                }
                                ?>
                                <td <?php echo $datasort;?> class="<?php echo $classhidden;?>">
                    ...
                    <?php if ($modulo['nome_modulo']=='Polizze') { ?>
                        <tfoot>
        ...
        <?php /* (i) ---------------------- Timbrature ---------------- */ ?>
        <?php if ($modulo['nome_modulo']=='Timbrature') { ?>
        <!-- (i) open street map -->
        <div id="osm-map"></div>
        ...
        if ($modulo['id_modulo']=='80') {
            ...
            <div class="row">
                <div class="col col-xs-12">
                    <div class="jumbotron">
                        <p class="lead">Al momento non è presente nessuna attività associata a questo cantiere!</p>

                        <p class="lead">
                            <a class="btn btn-success btn-lg" href="get_element.php?k=id_sede-<?php echo $idcantiere;?>&debug=&idmod=80&idele=-1&" role="button">Inserisci una attività!</a>
                        </p>
                    </div>
                </div>
            </div>
...
<script src="plupload/js/plupload.full.min.js"></script>
    ...
    jQuery(function($) {
        ...
        $(".aprimappaosm").on("click",function(){


            function setMarkersOsm(map,elencopost) {
            ...
            var offsetscroll=$("#osm-map").offset().top;
            ...
            //console.log(idsede);
            params.idattivita=idattivita;
            //console.log(params);
            $.ajax({
                type: "POST",
                url: "ajax_get_timbraturePerMappa.php",
                data: params,
                dataType: 'json',
                success: function(data){
                    ...
                    if (data.result==true) {
                        ...
                        taskmap=data.timbrature;
                        setMarkersOsm(map,taskmap);
                    } else {
                        $.notify(data.error);
                        console.log(data);
                    }
        ...
        $(".replicaattivita").click(function(){
...
//additional functions for data table
        ...
        $(".registravisita").click(function(){
            ...
            bootbox.prompt({
                ...
                callback: function (result) {
                    $.post("ajax_registra.php", { idmod: idmod, idele: idele, testo:result } , function(msg){$("#responso").html(msg);} );
                    setTimeout(function(){location.reload();}, 2000);
                }
            });
    ...
    <?php if ($numero_records>0) : ?>
        ...
        var table=$('.datatable')
            ...
            .dataTable( {
                ...
                "fnFooterCallback": function( nFoot, aaData, iStart, iEnd, aiDisplay ) {
                    var fTotalePremioNetto = 0;
                    var fTotalePremioLordo = 0;
                    var fTotaleProvvigioni = 0;
                    var fTotaleBrokeraggio = 0;

                    for (var i = 0; i < aiDisplay.length; i++) {
                        fTotalePremioNetto += 100*aaData[aiDisplay[i]][7];
                        fTotalePremioLordo += 100*aaData[aiDisplay[i]][8];
                        fTotaleProvvigioni += 100*aaData[aiDisplay[i]][9];
                        fTotaleBrokeraggio += 100*aaData[aiDisplay[i]][10];
                    }

                    /* Modify the footer row to match what we want */
                    $(nFoot).children().each(function(index, th){
                        //console.log(index);
                        if (index==1) { //totale premio netto
                            $(th).html(parseFloat(fTotalePremioNetto/100).toFixed(2));
                        }
                        if (index==2) { //totale premio netto
                            $(th).html(parseFloat(fTotalePremioLordo/100).toFixed(2));
                        }
                        if (index==3) { //totale premio netto
                            $(th).html(parseFloat(fTotaleProvvigioni/100).toFixed(2));
                        }
                        if (index==4) { //totale premio netto
                            $(th).html(parseFloat(fTotaleBrokeraggio/100).toFixed(2));
                        }
                    });
                }
                <?php } ?>
        ...
        $( document ).on( "change", ".cambianonrigenerare", function(e) {

            var nonrigenerare=$(this).prop('checked');
            //alert(eseguito);
            if (nonrigenerare==true) {
                nonrigenerare='si';
            } else {
                nonrigenerare='no';
            }

            var idattivita=$(this).attr('idattivita');

            $.ajax({
                type    :   'POST',
                url     :   'ajax_modifica_non_rigenerare.php',
                dataType: 'json',
                data    :   {idattivita:idattivita,val:nonrigenerare},
                success :   function(return_value){
                    console.log(return_value);

                    if (return_value.result==true) {

                    } else {
                        $.notify({
                            message: '<b>Salvataggio non riuscito:</b> <br/>'+return_value.error
                        },{
                            type: 'danger'
                        });
                    }
