                ...
                <div class="panel-body">
                        ...
                        <form method="post">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="precodice" name="precodice" placeholder="fl_">
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="numerocodici" name="numerocodici" placeholder="105">
                            </div>
                            <div class="form-group col-md-4">
