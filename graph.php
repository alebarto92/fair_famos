...
<body>
        ...
        <?php if ($_GET['idexperiments']!='') {
          $idexperiments=explode(",",$_GET['idexperiments']);
         } ?>
        <!--[if lt IE 8]>
        ...
        <div class="container" id="firstcontainer">
            ...
            <div class="row">
              <div class="col col-xs-12">
                ...
                $columnsnumber=4;
                if (count($idexperiments)>0) {
                  $listexperiments=join(",",$idexperiments);
                  $query="SELECT tbts.id,CONCAT(tbe.title,' ',tbts.column_name) as name from tb_time_series tbts JOIN tb_experiments tbe ON tbe.id=tbts.id_experiment WHERE tbe.id IN ($listexperiments)";
                  //echo $query;
                ...
                <br/>
                <input class="form-control" type="number" name="deltaT<?php echo $i;?>" id="deltaT<?php echo $i;?>" placeholder="insert offset in milliseconds"/>
                </div>
