							...
							if (count($files)>0) : ?>
								<ul id="immagini-sortable" class="sortable">
									...
									foreach ($files as $f) :
										...
										$pezzi[count($pezzi)-1]=$resizes[2]['prefisso']."_".$resizes[2]['width']."_".$resizes[2]['height']."_".$tmp;
										$nomefile=join("/",$pezzi);
										...
										<li class="file-sortable" id="file-<?php echo $f['id_file'];?>">
											<div class="row">
												<div class="col-xs-7">
                                                    <a target="_blank" href="<?php echo $sitoweb.$f['file'];?>"><img class="img-responsive" style="padding-bottom:5px;" width="300" height="300" alt="300x300" src="<?php echo $sitoweb.$nomefile;?>"/></a>
												</div>
												<div class="col-xs-5">
													<div class="tabbable">
