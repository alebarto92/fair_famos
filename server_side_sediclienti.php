    ...
    <div class="btn-group">
        <div class="btn-group" style="text-align:center;">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="get_element.php?debug=0&amp;idmod=10&amp;idele='.$d.'" data-toggle="tooltip" title="" class="green" data-original-title="Edit"><i class="glyphicon glyphicon-edit"></i> EDIT</a></li>
                <li class="red"><a data-toggle="tooltip" title="Delete" class="red delete-elemento" idmodalmod="10" idmodalele="'.$d.'" href="#" ><i class="glyphicon glyphicon-trash"></i> DELETE</a></li>
                <li class="divider"></li>
